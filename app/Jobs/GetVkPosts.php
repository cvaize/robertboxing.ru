...
class GetVkPosts implements ShouldQueue {
	...
	public function handle(VkPost $vkPosts) {
		...
		//Storage::disk('local')->append('posts_logs.txt', Carbon::now());
		//Storage::disk('local')->append('posts_logs.txt', 'Get posts: ');
		...
		foreach ($getVkPosts as $getVkPost) {
			...
			//Storage::disk('local')->append('posts_logs.txt', $getVkPost['id']);
			dump($getVkPost['id']);
		...
		//Storage::disk('local')->append('posts_logs.txt', '===========================');
		dump('===========================');
