<nav class="js-navbar bg-white">
  <div class="container-fluid container-fluid--max navbar navbar-expand-lg">
    <button class="navbar-toggler order-1" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse order-3 order-lg-2" id="navbarTogglerDemo03">
    ...
    <div class="order-2 order-lg-3">
      <div class="nav-item">
        <a class="nav-link nav-link--orange font-weight-bold" href="tel:89222224406">8 922 222-44-06</a>
      </div>
    </div>
  </div>
</nav>